...
void Filters::GaussianBlur(Image& Source, Image& Dest, float Sigma)
{
   ...
   if (Sigma <= 0 || MaskSize > 31)
      throw std::invalid_argument("Invalid sigma used with GaussianBlur - allowed : 0.01-10");
...
void Filters::Gauss(Image& Source, Image& Dest, int Width)
{
   ...
   throw std::invalid_argument("Invalid width used in Gauss - allowed : 3, 5");
}
...
void Filters::Sharpen(Image& Source, Image& Dest, int Width)
{
   ...
   if (Width != 3)
      throw std::invalid_argument("Invalid width used in Sharpen - allowed : 3");
...
void Filters::Smooth(Image& Source, Image& Dest, int Width)
{
   ...
   if (Width < 3 || (Width & 1) == 0)
      throw std::invalid_argument("Invalid width used in Smooth");
...
void Filters::Median(Image& Source, Image& Dest, int Width)
{
   ...
   if (Width != 3 && Width != 5)
      throw std::invalid_argument("Invalid width used in Median - allowed : 3 or 5");
...
void Filters::SobelVert(Image& Source, Image& Dest, int Width)
{
   ...
   throw std::invalid_argument("Invalid width used in SobelVert - allowed : 3, 5");
}
...
void Filters::SobelHoriz(Image& Source, Image& Dest, int Width)
{
   ...
   throw std::invalid_argument("Invalid width used in SobelHoriz - allowed : 3, 5");
}
...
void Filters::SobelCross(Image& Source, Image& Dest, int Width)
{
   ...
   throw std::invalid_argument("Invalid width used in SobelCross - allowed : 3, 5");
}
...
void Filters::Sobel(Image& Source, Image& Dest, int Width)
{
   ...
   throw std::invalid_argument("Invalid width used in Sobel - allowed : 3, 5");
}
...
void Filters::PrewittVert(Image& Source, Image& Dest, int Width)
{
   ...
   throw std::invalid_argument("Invalid width used in PrewittVert - allowed : 3");
}
...
void Filters::PrewittHoriz(Image& Source, Image& Dest, int Width)
{
   ...
   throw std::invalid_argument("Invalid width used in PrewittHoriz - allowed : 3");
}
...
void Filters::Prewitt(Image& Source, Image& Dest, int Width)
{
   ...
   throw std::invalid_argument("Invalid width used in Prewitt - allowed : 3");
}
...
void Filters::ScharrVert(Image& Source, Image& Dest, int Width)
{
   ...
   throw std::invalid_argument("Invalid width used in ScharrVert - allowed : 3");
}
...
void Filters::ScharrHoriz(Image& Source, Image& Dest, int Width)
{
   ...
   throw std::invalid_argument("Invalid width used in ScharrHoriz - allowed : 3");
}
...
void Filters::Scharr(Image& Source, Image& Dest, int Width)
{
   ...
   throw std::invalid_argument("Invalid width used in Scharr - allowed : 3");
}
...
void Filters::Hipass(Image& Source, Image& Dest, int Width)
{
   ...
   throw std::invalid_argument("Invalid width used in Hipass - allowed : 3, 5");
}
...
void Filters::Laplace(Image& Source, Image& Dest, int Width)
{
   ...
   throw std::invalid_argument("Invalid width used in Laplace - allowed : 3, 5");
}
